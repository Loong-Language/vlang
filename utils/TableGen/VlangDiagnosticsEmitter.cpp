//=- VlangDiagnosticsEmitter.cpp - Generate Vlang diagnostics tables -*- C++ -*-
//
...
//===----------------------------------------------------------------------===//
//
// These tablegen backends emit Vlang diagnostics tables.
//
//===----------------------------------------------------------------------===//
...
static void groupDiagnostics(const std::vector<Record*> &Diags,
  ...
  // groups (these are warnings that GCC supports that vlang never produces).
  for (unsigned i = 0, e = DiagGroups.size(); i != e; ++i) {
...
/// VlangDiagsDefsEmitter - The top-level class emits .def files containing
/// declarations of Vlang diagnostics.
namespace vlang {
