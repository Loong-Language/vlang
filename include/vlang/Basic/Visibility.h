...
///
/// \file
/// \brief Defines the vlang::Visibility enumeration and various utility
/// functions.
///
//===----------------------------------------------------------------------===//
#ifndef LLVM_VLANG_BASIC_VISIBILITY_H
#define LLVM_VLANG_BASIC_VISIBILITY_H

#include "vlang/Basic/Linkage.h"
...
#endif // LLVM_VLANG_BASIC_VISIBILITY_H
