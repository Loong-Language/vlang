...
#ifndef LLVM_VLANG_SOURCEMANAGER_H
#define LLVM_VLANG_SOURCEMANAGER_H
...
namespace SrcMgr {
  ...
  class FileInfo {
    ...
    friend class vlang::SourceManager;
    friend class vlang::ASTWriter;
    friend class vlang::ASTReader;
  public:
