...
///
/// \file
/// \brief Defines the vlang::VersionTuple class, which represents a version in
/// the form major[.minor[.subminor]].
///
//===----------------------------------------------------------------------===//
#ifndef LLVM_VLANG_BASIC_VERSIONTUPLE_H
#define LLVM_VLANG_BASIC_VERSIONTUPLE_H
...
#endif // LLVM_VLANG_BASIC_VERSIONTUPLE_H
