...
///
/// \file
/// \brief Defines implementation details of the vlang::SourceManager class.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_VLANG_SOURCEMANAGER_INTERNALS_H
#define LLVM_VLANG_SOURCEMANAGER_INTERNALS_H
