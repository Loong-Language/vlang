...
///
/// \file
/// \brief Defines the vlang::FrontendAction interface and various convenience
/// abstract classes (vlang::ASTFrontendAction, vlang::PluginASTAction,
/// vlang::PreprocessorFrontendAction, and vlang::WrapperFrontendAction)
/// derived from it.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_VLANG_FRONTEND_FRONTENDACTION_H
#define LLVM_VLANG_FRONTEND_FRONTENDACTION_H
