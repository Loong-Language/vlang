...
///
/// \file
/// \brief Defines the vlang::MacroInfo and vlang::MacroDirective classes.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_VLANG_MACROINFO_H
#define LLVM_VLANG_MACROINFO_H

#include "vlang/Lex/Token.h"
...
protected:
  ...
  MacroDirective(Kind K, SourceLocation Loc)
    : Previous(0), Loc(Loc), MDKind(K), IsHidden(false), IsAmbiguous(false),
      IsPublic(true) {
  }
