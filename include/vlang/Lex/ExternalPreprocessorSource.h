...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_VLANG_LEX_EXTERNAL_PREPROCESSOR_SOURCE_H
#define LLVM_VLANG_LEX_EXTERNAL_PREPROCESSOR_SOURCE_H
...
#endif // LLVM_VLANG_LEX_EXTERNAL_PREPROCESSOR_SOURCE_H
