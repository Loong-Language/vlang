...
#ifndef LLVM_VLANG_LEX_HEADERSEARCHOPTIONS_H
#define LLVM_VLANG_LEX_HEADERSEARCHOPTIONS_H
...
public:
  ...
  ///
  /// This operation is expensive, because it requires Vlang to walk through
...
public:
  ...
  void AddPath(StringRef Path, frontend::IncludeDirGroup Group,
               bool IgnoreSysRoot) {
    UserEntries.push_back(Entry(Path, Group, IgnoreSysRoot));
  }
