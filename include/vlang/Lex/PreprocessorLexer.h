...
#ifndef LLVM_VLANG_PreprocessorLexer_H
#define LLVM_VLANG_PreprocessorLexer_H

#include "vlang/Lex/MultipleIncludeOpt.h"
...
protected:
  ...
  /// \brief Information about the set of \`ifdef/\`ifndef blocks
  /// we are currently in.
