...
void PreprocessingRecord::InclusionDirective(
  ...
  switch (IncludeTok.getIdentifierInfo()->getTokenID()) {
  case tok::pp_include: 
  ...
  vlang::InclusionDirective *ID
    = new (*this) vlang::InclusionDirective(*this, Kind, FileName, !IsAngled,
                                            (bool)Imported,
